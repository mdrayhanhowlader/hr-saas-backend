...
import { getAttendances, checkIn, checkOut, getMyAttendance, updateAttendance, getAttendanceStats, biometricPunch, manualAttendance } from '../controllers/attendance.controller';
...
router.post('/manual', authenticate, authorize('HR_ADMIN', 'SUPER_ADMIN'), manualAttendance);
